<template>
  <div class="fill-blank-question-container">
    <!-- 顶部导航 -->
    <div class="header-nav">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>题目面板</el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '' }">添加填空类题</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
onMounted(() => {
  ...
  console.log('添加填空题页接收的题库ID:', bankId);
