  ...
  <div class="edit-judge-question-container">
    ...
    <div class="header-nav">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '' }">编辑判断题</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <el-card class="question-card">
      ...
      <div class="form-section">
        ...
        <el-radio-group v-model="judgeAnswer" class="judge-radio-group">
...
const fetchTopicDetail = async () => {
  ...
  await api.getTopicDetail(
    ...
    (data) => {
      ...
      judgeAnswer.value = data.topic_answer || '';
...
const updateQuestion = async () => {
  ...
  const questionData = {
    ...
    topic_answer: judgeAnswer.value,
